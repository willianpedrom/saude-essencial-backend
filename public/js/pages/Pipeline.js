...
import { toast, modal, openClientOffcanvas } from '../utils.js?v=1010';
    ...
    <div class="pipeline-card"
      ...
      <div class="pipeline-card-header">
        ...
        <div class="pipeline-card-info">
          <div class="pipeline-card-name">${fullName || '—'} ${client.tipo_cadastro === 'preferencial' ? ' 🛍️' : client.tipo_cadastro === 'varejo' ? ' 🛒' : client.tipo_cadastro === 'consultora' ? ' 💼' : ''}</div>
