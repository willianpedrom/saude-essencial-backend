import { auth, store } from '../store.js?v=1004';
import { renderLayout } from './Dashboard.js?v=1004';
import { formatDate, getInitials, toast, modal, openClientOffcanvas } from '../utils.js?v=1004';
import { analyzeAnamnesis, analyzeBusinessProfile } from '../analysis.js?v=1004';
import { PROTOCOLS } from '../protocols.js?v=1004';
import { OILS_DATABASE } from '../oils.js?v=1004';
  ...
  function showImportModal() {
    ...
    overlay.querySelector('#btn-do-import').addEventListener('click', async () => {
      ...
      try {
        ...
        const { api } = await import('../store.js?v=1004').then(m => ({ api: m.api }));
