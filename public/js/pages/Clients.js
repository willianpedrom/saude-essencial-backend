import { auth, store } from '../store.js?v=1000';
import { renderLayout } from './Dashboard.js?v=1000';
import { formatDate, getInitials, toast, modal, openClientOffcanvas } from '../utils.js?v=1000';
import { analyzeAnamnesis, analyzeBusinessProfile } from '../analysis.js?v=1000';
import { PROTOCOLS } from '../protocols.js?v=1000';
import { OILS_DATABASE } from '../oils.js?v=1000';
      ...
      if (navigator.clipboard && window.ClipboardItem) {
        try {
          const fetchHash = async () => {
            const { api } = await import('../store.js?v=1000');
  ...
  function showImportModal() {
    ...
    overlay.querySelector('#btn-do-import').addEventListener('click', async () => {
      ...
      try {
        ...
        const { api } = await import('../store.js?v=1000').then(m => ({ api: m.api }));
