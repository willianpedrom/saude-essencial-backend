...
import { formatDate, getInitials, toast, modal, openClientOffcanvas } from '../utils.js?v=1007';
import { analyzeAnamnesis, analyzeBusinessProfile } from '../analysis.js?v=1007';
import { PROTOCOLS } from '../protocols.js?v=1007';
import { OILS_DATABASE } from '../oils.js?v=1007';
  ...
  function showImportModal() {
    ...
    overlay.querySelector('#btn-do-import').addEventListener('click', async () => {
      ...
      try {
        ...
        const { api } = await import('../store.js?v=1007').then(m => ({ api: m.api }));
