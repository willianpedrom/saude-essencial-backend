...
import { formatDate, getInitials, toast, modal, openClientOffcanvas } from '../utils.js?v=1002';
import { analyzeAnamnesis, analyzeBusinessProfile } from '../analysis.js?v=1002';
import { PROTOCOLS } from '../protocols.js?v=1002';
import { OILS_DATABASE } from '../oils.js?v=1002';
  ...
  function showImportModal() {
    ...
    overlay.querySelector('#btn-do-import').addEventListener('click', async () => {
      ...
      try {
        ...
        const { api } = await import('../store.js?v=1002').then(m => ({ api: m.api }));
