...
import { formatDate, getInitials, toast, modal, openClientOffcanvas } from '../utils.js?v=1003';
import { analyzeAnamnesis, analyzeBusinessProfile } from '../analysis.js?v=1003';
import { PROTOCOLS } from '../protocols.js?v=1003';
import { OILS_DATABASE } from '../oils.js?v=1003';
  ...
  function showImportModal() {
    ...
    overlay.querySelector('#btn-do-import').addEventListener('click', async () => {
      ...
      try {
        ...
        const { api } = await import('../store.js?v=1003').then(m => ({ api: m.api }));
