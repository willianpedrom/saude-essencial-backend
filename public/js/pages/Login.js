  ...
  <div class="auth-page">
    ...
    <div class="auth-card">
      <div class="auth-logo" style="margin-bottom:32px; display:flex; justify-content:center;">
        <img src="/img/logo_premium.png?v=1009" alt="Gota App Logo" style="width:100%; max-width:320px; height:auto; object-fit:contain; filter: drop-shadow(0 4px 12px rgba(0,0,0,0.15));" />
      </div>
  ...
  <div class="auth-page">
    ...
    <div class="auth-card">
      <div class="auth-logo" style="margin-bottom:12px">
        <img src="/logo.png?v=1009" alt="Gota App" style="height:120px;width:auto;object-fit:contain" />
      </div>
