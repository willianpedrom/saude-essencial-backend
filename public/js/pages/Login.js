  ...
  <div class="auth-page">
    ...
    <div class="auth-card">
      <div class="auth-logo" style="margin-bottom:32px; display:flex; justify-content:center;">
        <img src="/img/logo_premium.png?v=1010" alt="Gota App Logo" style="width:100%; max-width:320px; height:auto; object-fit:contain; filter: drop-shadow(0 4px 12px rgba(0,0,0,0.15));" />
      </div>
          ...
          if (data.lider_foto_url) {
            fotoHtml = `
              <div style="margin-bottom: 16px; display: flex; justify-content: center;">
                <img src="${data.lider_foto_url}" style="width:96px; height:96px; border-radius:50%; object-fit:cover; border:3px solid #4ade80; box-shadow: 0 0 25px rgba(74, 222, 128, 0.55);" />
              </div>
            `;
          }
  ...
  <div class="auth-page">
    ...
    <div class="auth-card">
      <div class="auth-logo" style="margin-bottom:12px">
        <img src="/logo.png?v=1010" alt="Gota App" style="height:120px;width:auto;object-fit:contain" />
      </div>
