...
export async function renderPublicProfile(router, slug) {
    ...
    <style>
      ...
      * { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      .pp-btn { display: inline-flex; align-items: center; gap: 10px; padding: 16px 32px; border-radius: 50px; font-weight: 700; font-size: 1rem; cursor: pointer; border: none; text-decoration: none; transition: transform .15s, box-shadow .15s; }
      .pp-btn:hover { transform: translateY(-2px); box-shadow: 0 8px 24px rgba(0,0,0,0.2); }
      .pp-btn-primary { background: linear-gradient(135deg,#16a34a,#15803d); color: white; }
      .pp-btn-whatsapp { background: #25d366; color: white; }
      .pp-btn-secondary { background: white; color: #1a4527; border: 2px solid #1a4527; }
    ...
    <section style="background:linear-gradient(160deg,#0a2818 0%,#1a4527 50%,#134020 100%);padding:80px 24px 60px;text-align:center;position:relative;overflow:hidden">
      ...
      <div class="pp-container pp-fade">
        ...
        <p style="color:rgba(255,255,255,0.65);font-size:1rem;margin-bottom:24px">${title} de Bem-Estar Natural · Gota Essencial</p>
        ...
        <div style="display:flex;flex-wrap:wrap;justify-content:center;gap:14px">
          ${anamneseLink
            ? `<a href="${anamneseLink}" class="pp-btn pp-btn-primary">
                📋 Quero minha avaliação gratuita
               </a>`
            : ''}
          ${whatsLink
            ? `<a href="${whatsLink}" target="_blank" class="pp-btn pp-btn-whatsapp">
        ...
        <div style="margin-top:28px;display:inline-flex;align-items:center;gap:8px;background:rgba(255,255,255,0.1);padding:8px 20px;border-radius:30px">
          ...
          <span style="color:white;font-weight:600">${avgNps}/10</span>
          <span style="color:rgba(255,255,255,0.6);font-size:0.85rem">${depoimentos.length} avaliações de clientes</span>
        </div>` : ''}
      </div>
    </section>
    ...
    <!-- ═══════════════ SOBRE ═══════════════ -->
    ${bio ? `
    <section class="pp-section" style="background:#f9fafb">
      <div class="pp-container pp-fade">
        <div style="text-align:center;margin-bottom:32px">
          ...
          <h2 style="font-family:'Playfair Display',serif;font-size:clamp(1.6rem,4vw,2.2rem);color:#0a2818">Minha história</h2>
        </div>
    ...
    <section class="pp-section" style="background:white">
    ...
    <section style="background:linear-gradient(135deg,#0a2818,#1a4527);padding:80px 24px;text-align:center">
      <div class="pp-container pp-fade">
        ...
        <h2 style="font-family:'Playfair Display',serif;color:white;font-size:clamp(1.8rem,4vw,2.4rem);margin-bottom:12px">Comece sua transformação hoje</h2>
        <p style="color:rgba(255,255,255,0.7);max-width:480px;margin:0 auto 36px;line-height:1.7">Receba gratuitamente uma avaliação personalizada e descubra os melhores protocolos naturais para sua saúde.</p>
        ...
        <div>
          ...
          <div style="display:flex;justify-content:center;gap:10px;flex-wrap:wrap">
            ...
            <a href="https://wa.me/?text=${encodeURIComponent('Conheça o perfil de ' + nome + ': ' + pageUrl)}" target="_blank"
              style="background:#25d366;color:white;border:none;padding:10px 20px;border-radius:30px;cursor:pointer;font-size:0.85rem;text-decoration:none;display:inline-flex;align-items:center;gap:6px">
    ...
    <footer style="background:#071a0f;padding:20px 24px;text-align:center">
      <p style="color:rgba(255,255,255,0.3);font-size:0.78rem">Powered by <strong style="color:rgba(255,255,255,0.5)">Gota Essencial</strong> · Sistema de Consultoras de Bem-Estar</p>
    </footer>`;
}
