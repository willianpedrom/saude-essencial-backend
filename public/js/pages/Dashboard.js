...
import { formatDate, formatCurrency, getInitials, toast, getConsultantTitle } from '../utils.js?v=1001';
...
function processNextAviso(avisos, index) {
  ...
  import('../utils.js?v=1001').then(({ modal }) => {
    modal(
  ...
  <div class="app-layout">
    <aside class="sidebar" id="sidebar">
      <div class="sidebar-logo" id="sidebar-logo" style="margin-bottom:12px">
        <img src="/logo.png?v=1001" alt="Gota App" style="width:100%;max-width:180px;height:auto;object-fit:contain" />
      </div>
...
window.dashboardDoneFu = function (id) {
  try {
    ...
    if (idx >= 0) {
      ...
      import('../utils.js?v=1001').then(m => m.toast('Follow-up concluído! ✅'));
      // re-render
      const app = document.getElementById('app');
